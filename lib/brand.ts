...
export const brand: Brand = {
  name: "AllureLuxe Beauty Bar",
  shortName: "AllureLuxe",
  microTag: "SOFT LIFE STARTS HERE",
  description:
    "AllureLuxe Beauty Bar is a Koforidua beauty studio where treatments, care and calm come together under one roof.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0554330590",
    phoneTel: "+233554330590",
    textPhone: "0547855798",
    textPhoneTel: "+233547855798",
    email: "hello@allureluxe.test",
    privacyEmail: "privacy@allureluxe.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@allureluxe.beautybar", icon: "tiktok" },
  ],
  ...
  hero: {
    badge: "Now booking",
    title: "the soft life starts\nat allureluxe.\nSoft life starts here.",
    subtitle:
      "Facials, massage, nails and more in Koforidua — book your treatment today",
  ...
  editorial: {
    ...
    notes: [
      {
        body: "Between work and everything else, Koforidua does not slow down for anyone — and your body keeps the score of every rushed week.",
        className: "left-[5%] top-[25%] max-w-[330px]",
      },
      {
        body: "At AllureLuxe Beauty Bar, self-care is not a someday luxury. It is an hour that fits into your actual life and pays you back all week.",
    ...
    images: [
      {
        ...
        alt: "AllureLuxe Beauty Bar beauty treatment detail",
      ...
      },
      {
        ...
        alt: "AllureLuxe Beauty Bar self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "AllureLuxe Beauty Bar beauty ritual",
      ...
      },
      {
        ...
        alt: "AllureLuxe Beauty Bar calm care moment",
        className: "right-[6%] top-[68%] h-[145px] w-[100px] rounded-[999px]",
        sizes: "100px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "AllureLuxe Beauty Bar relaxation detail",
        className: "left-[25%] top-[75%] h-[150px] w-[102px] rounded-[999px]",
        sizes: "102px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/bgkgjrchbkhtckgh9f7t.jpg",
        alt: "AllureLuxe Beauty Bar beauty and peace detail",
    ...
    items: [
      {
        ...
        imageAlt: "AllureLuxe Beauty Bar lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "AllureLuxe Beauty Bar mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "AllureLuxe Beauty Bar makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "AllureLuxe Beauty Bar foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  media: {
    title: "media",
    ctaLabel: "Follow",
    ctaHref: "https://www.tiktok.com/@allureluxe.beautybar",
    images: [
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783493297/stage4/spa_allureluxebeautybar/tiktok_0.mp4",
        alt: "AllureLuxe Beauty Bar treatment video",
        position: "center",
      },
      {
      ...
      },
      {
        ...
        alt: "AllureLuxe Beauty Bar self-care media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581409/pq6ritvfxvxkhsjqkct4.mp4",
        alt: "AllureLuxe Beauty Bar studio media video",
        position: "center",
      },
    ],
  },
  ...
  about: {
    eyebrow: "About AllureLuxe Beauty Bar",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "AllureLuxe Beauty Bar is a curated beauty and self-care space in Koforidua, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Koforidua. Use the Location page for the exact Google Maps pin, or call 0554330590 and text 0547855798 for booking help.",
      },
    ],
  },
  ...
  faq: {
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0554330590, text 0547855798, or message @allureluxe.beautybar on Instagram." },
          ...
          { q: "Where are you located?", a: "AllureLuxe Beauty Bar is in Koforidua. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
    ...
    contactEmail: "hello@allureluxe.test",
  },
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "AllureLuxe Beauty Bar (\"we\", \"us\") is a beauty and self-care business in Koforidua, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@allureluxe.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "AllureLuxe Beauty Bar is in Koforidua. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@allureluxe.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to AllureLuxe Beauty Bar",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0554330590", href: "tel:+233554330590" },
      { label: "Text", value: "0547855798", href: "sms:+233547855798" },
      { label: "Instagram", value: "@allureluxe.beautybar", href: "https://www.tiktok.com/@allureluxe.beautybar" },
    ],
  },
  ...
  footer: {
    blurb:
      "AllureLuxe Beauty Bar in Koforidua — soft life starts here.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@allureluxe.beautybar" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0554330590", href: "tel:+233554330590" },
          { label: "Text 0547855798", href: "sms:+233547855798" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "AllureLuxe Beauty Bar — beauty and self-care in Koforidua. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },
