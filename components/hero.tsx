...
export function Hero({
  ...
  return (
    <section className="spa-video-hero relative isolate h-[95svh] min-h-[620px] overflow-hidden rounded-b-[28px] bg-[#6f3000] text-white lg:rounded-b-[36px]">
      {heroVideos.length > 0 ? (
        ...
        <div className="absolute inset-0 -z-20 bg-[#7e3600]" />
      )}
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(73, 26, 0,0.58),rgba(101, 27, 0,0.22)_43%,rgba(75, 30, 0,0.34)),linear-gradient(0deg,rgba(39, 17, 0,0.18),rgba(39, 17, 0,0.08))]" />
