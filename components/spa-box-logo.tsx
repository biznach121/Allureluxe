...
const LOGO_URL =
  "https://res.cloudinary.com/dzykdnbvb/raw/upload/v1783493293/stage4/spa_allureluxebeautybar/logo.svg";
...
export function SpaBoxLogo({ className = "", compact = false, tone = "light" }: SpaBoxLogoProps) {
  ...
  if (REAL_LOGO) {
    ...
    return (
      <span className={["relative inline-block", sizeClass, className].join(" ")} aria-label="AllureLuxe Beauty Bar - Soft life starts here">
        <Image
          src={src}
          alt="AllureLuxe Beauty Bar - Soft life starts here"
          fill
